...
--update produtos set VALOR = VALOR * 1.12 where NOME LIKE 'F%; 
    ...
    --2
     update produtos set QUANTIDADE = QUANTIDADE + 50 where VALOR > 400 and < 600;

        --3
    UPDATE PRODUTOS SET VALOR = VALOR * 0.50 WHERE TIPO = 'produtos' OR VALOR > 300.00
 
            --4
            select * from PRODUTOS where codigo like '%4';

                --5
                select * from PRODUTOS where NOME NOT LIKE like '%y';
