...
insert into animais(codigo,tipo,nome,idade,valor)
...
select 'Animal Domestico' as 'Procedencia',tipo as 'Tipo',nome as "Nome",idade as "Tempo de Vida" from animais;

-- 9. Escreva um comando que apresente os dados da tabela ANIMAIS da seguinte forma:

select tipo as 'Tipo',nome as 'Nome',idade as 'Idade',valor as 'Valor Original', valor * 1.10 as 'Valor de Venda' from animais;
...
select distinct tipo as 'Tipo',valor as 'Valor Original', valor * 1.10 as 'Valor de Venda' from animais;
